...
export class TextCaptcha implements OnInit {
  ...
  // ── OUTPUT: tells parent the user passed ───────────────────
  // parent listens with (passed)="onStagePassed()"
  ...
  // cyan shades used for characters
   readonly COLORS  = [
  ...
  // the generated secret — NOT a signal (regenerated by method)
  private secret = '';

  // SVG data arrays — regenerated on refresh
